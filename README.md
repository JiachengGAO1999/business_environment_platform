...
- 报告结构：摘要与总体判断、政治举措及地缘环境、金融投资环境、产业政策及市场环境、合规与法治环境、新质生产力与科创环境、社会人文环境、企业行动建议、待复核问题
...
| 分析报告 | `reportsSixDimension.ts` + `real/saudi.ts` | 3 份（2 mock + 1 real） |
| 审核记录 | `reports.ts` | 5 条 |

数据统一覆盖六维营商环境模型：政治举措及地缘环境、金融投资环境、产业政策及市场环境、合规与法治环境、新质生产力与科创环境、社会人文环境。

Mock 数据标记为 `dataOrigin: 'mock'`，沙特真实来源样本和真实来源模拟导入数据标记为 `dataOrigin: 'real'`。
